    ...
    <meta charset="utf-8">
      <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width,initial-scale=1">
          <title>Center Administration Mass - CAM</title>
          <!-- Bootstrap -->
          <link href="libs/css/bootstrap.min.css" rel="stylesheet">
            <link href="libs/css/custom.css" rel="stylesheet">
              <link href="libs/css/toaster.css" rel="stylesheet">
                <style>
                  a {
                  color: orange;
                  }
...
<![endif]-->
  ...
  <script src="/cam/libs/js/jquery-2.2.4.min.js"></script>
  <script src="libs/js/toaster.js"></script>
